...
public class Login extends javax.swing.JFrame {
    ...
    public boolean checkValue(){
       ...
       if (txtusername.getText().isEmpty()){
           JOptionPane.showMessageDialog(this,"Chua Nhap user name! ","Thong Bao",3);
           return false;
       }
       if(mk.isEmpty()){
           JOptionPane.showMessageDialog(this, "Chua nhap mat khau!","Thong bao",3);
           return false;
       }
       if(tk.equals("admin") && (mk.equals("123"))){
           JOptionPane.showMessageDialog(this, "Dang Nhap Thanh Cong","Thong bao",3);
           QLyDiem a = new QLyDiem();
            a.setVisible(true);
            this.dispose();
           
       }
       else{
           JOptionPane.showMessageDialog(this, "Tai khoan hoac mau khau sai, vui long nhap lai!","thong bao",3);
       }
       return true;
